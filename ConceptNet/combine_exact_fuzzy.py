'''
 @Date  : 01/12/2020 (edited 11/03/2022)
 @Author: Zhihan Zhang + Ghazaleh Kazeminejad
 @mail  : zhangzhihan@pku.edu.cn + ghka9436@colorado.edu
...
def combine_retrieval(bert_triples: List[str], rule_triples: List[str], max_num: int,
                      para_id: int, entity: str) -> Tuple[List[str], int, int]:
    """
